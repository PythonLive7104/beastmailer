...
class MailboxSerializer(serializers.ModelSerializer):
    ...
    remaining_sends_today = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = [
            ...
            "daily_send_limit", "sent_today", "remaining_sends_today",
            "poll_interval_seconds", "reply_delay_minutes",
            "last_polled_at", "last_seen_uid", "last_error",
            "created_at", "updated_at",
        ]
        read_only_fields = ["last_polled_at", "last_seen_uid", "last_error", "sent_today",
                            "created_at", "updated_at"]

    def get_has_password(self, obj) -> bool:
        return bool(obj.password_encrypted)

    def get_remaining_sends_today(self, obj):
        return obj.remaining_sends_today()
