...
class Config(models.Model):
    ...
    reply_delay_minutes = models.PositiveIntegerField(
        default=15, help_text="Wait this long after receiving before sending an auto-reply"
    )
    poll_interval_seconds = models.PositiveIntegerField(
        default=30, help_text="How often the engine checks mailboxes for new mail"
    )
